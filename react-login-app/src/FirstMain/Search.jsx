...
import searchBtn from '../assets/SearchBtn.svg'; // 검색 버튼
import NoImage from '../assets/NoImage.svg'; // 골프장 이미지 없음
...
function GolfSearch() {
    ...
    const { GOLF_COURSES_SEARCH } = API_ENDPOINTS;
    const handleSearch = useCallback(async () => {
        ...
        try {
            const response = await fetch(
                `${GOLF_COURSES_SEARCH}?name=${encodeURIComponent(searchTerm)}`
            );
